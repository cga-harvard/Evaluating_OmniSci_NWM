...
for datels in date:
	...
	#print(file_suffix)
		...
		filename='nwm.'+file_prefix+'.medium_range.channel_rt.'+ suffix + '.conus.nc'
		KEY = model_name+'/'+ datels +'/'+ time + '/'+ 'nwm.'+ file_prefix+ '.medium_range.channel_rt.'+ suffix + '.conus.nc' # replace with your object key
