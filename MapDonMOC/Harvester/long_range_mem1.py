...
url = 'ftp://ftpprd.ncep.noaa.gov/pub/data/nccf/com/nwm/prod/'+ folder +'/long_range_mem1/'

# In[13]:

response = urllib.request.urlopen(url)
path_base = "/data/nwm_data"+ "/long_range_mem1/"+ yesterday_str
metadata_dict={}
metadata_filename= "metadata_"+  "long_range_mem1_"+ yesterday_str+ ".csv"
#os.mkdir(path, 0777)
