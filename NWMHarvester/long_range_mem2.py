...
url = 'ftp://ftpprd.ncep.noaa.gov/pub/data/nccf/com/nwm/prod/'+ folder +'/long_range_mem2/'

# In[13]:

response = urllib.request.urlopen(url)
path_base = "/Users/Happy/Desktop/data"+ "/long_range_mem2/"+ yesterday_str
metadata_dict={}
metadata_filename= "metadata_"+  "long_range_mem2_"+ yesterday_str+ ".csv"
#os.mkdir(path, 0777)
